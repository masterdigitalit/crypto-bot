...
from keyboard import registration as registration_kb, Start, confirmationButton, confirmationButtonDaily
    ...
    if(data[0:5] == 'back:'):
        ...
        if data[0:5] == 'last:':
            ...
            if(isProjectHasDaily(data[5:])[0]):
                ...
                await bot.edit_message_reply_markup(chat_id=callback_query.from_user.id,
                                                    message_id=callback_query.message.message_id,
                                                    reply_markup=confirmationButtonDaily(codes, True))
            else:
                code = f'{uuid.uuid4()}'
                ...
                await bot.edit_message_reply_markup(chat_id=callback_query.from_user.id,
                                                    message_id=callback_query.message.message_id,
                                                    reply_markup=confirmationButton(code, True))
        else:
            if (isProjectHasDaily(data)[0]):
                ...
                await bot.edit_message_reply_markup(chat_id=callback_query.from_user.id,
                                                    message_id=callback_query.message.message_id,
                                                    reply_markup=confirmationButtonDaily(codes, False))
            else:
                code = f'{uuid.uuid4()}'
                ...
                await bot.edit_message_reply_markup(chat_id=callback_query.from_user.id,
                                                    message_id=callback_query.message.message_id,
                                                    reply_markup=confirmationButton(code, False))
